...
rfdat.cohst<-rfdat.cohst[,!grepl("borderhu12s",rfdat.cohst)]
...
plot(predcoh.lt, rfdat.cohlt$accndvicoh.ts2, xlab="predicted", ylab="empirical", main="Coherence, long ts",
     xlim=c(0,1), ylim=c(0,1))
abline(a=0,b=1)
cor.test(predcoh.st,rfdat.cohlt$accndvicoh.ts2)
...
cforest.phi.st<-cforest(cos(accndviphi.ts1) ~ shoredev + lake_area_ha + maxdepth + pct.ag + chla + tsi.cat + 
                        ...
                        data=modvars.accndvi.phist,controls=cforest_control(ntree=50000))
...
cforest.phi.lt<-cforest(cos(accndviphi.ts2) ~ shoredev + lake_area_ha + maxdepth + pct.ag + chla + tsi.cat + hu4_zoneid + 
                        ...
                        data=modvars.accndvi.philt,controls=cforest_control(ntree=50000))
