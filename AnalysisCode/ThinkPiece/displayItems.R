...
plot(tt,y1+y2+y3+y4, type="l",xaxt="n", xlab="", yaxt="n", ylab="Integrated")
...
plot(tt,y2,type="l",xaxt="n",xlab="", yaxt="n", ylab="Seasonal")
axis(1,at=c(1,5,10,15,20,25,30),labels=FALSE)
axis(2,at=pretty(y2,5),labels=FALSE,xpd=F)
text(0.5,0.85,"B")

plot(tt,y3,type="l",xaxt="n",xlab="", yaxt="n", ylab="Multi-annual")
axis(1,at=c(1,5,10,15,20,25,30),labels=FALSE)
axis(2,at=pretty(y3,5),labels=FALSE,xpd=F)
text(0.5,0.65,"C")

plot(tt,y1,type="l",xaxt="n",xlab="", yaxt="n", ylab="Long-term trend")
