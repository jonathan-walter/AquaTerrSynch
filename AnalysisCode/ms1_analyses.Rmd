...
dredge.coh.accndvi.st<-dredge(gls.coh.accndvi.st, beta="sd") #intercept only is best model. Disappointing.
...
dredge.p.accndvi.st<-dredge(gls.p.accndvi.st, beta="sd") #intercept only is best model. Disappointing.
...
dredge.phi.accndvi.st<-dredge(gls.phi.accndvi.st, beta="sd") #intercept only is best model. Disappointing.
...
dredge.coh.accndvi.lt<-dredge(gls.coh.accndvi.lt, beta="sd") #intercept only is best model. Disappointing.
...
dredge.p.accndvi.lt<-dredge(gls.p.accndvi.lt, beta="sd") #intercept only is best model. Disappointing.
...
dredge.phi.accndvi.lt<-dredge(gls.phi.accndvi.lt, beta="sd") #intercept only is best model. Disappointing.
...
dredge.coh.accndvi.st<-dredge(lme.coh.accndvi.st, beta="sd") #intercept only is best model. Disappointing.
print(head(dredge.coh.accndvi.st))
...
dredge.p.accndvi.st<-dredge(lme.p.accndvi.st, beta="sd") #intercept only is best model. Disappointing.
print(head(dredge.p.accndvi.st))
...
dredge.phi.accndvi.st<-dredge(lme.phi.accndvi.st, beta="sd") #model with TSI is unconvincingly better than intercept-only (dAIC = 0.92)
print(head(dredge.phi.accndvi.st))
...
dredge.coh.accndvi.lt<-dredge(lme.coh.accndvi.lt, beta="sd") #lake type is marginal improvement over intercept only (dAIC = 0.1)
print(head(dredge.coh.accndvi.lt))
...
dredge.p.accndvi.lt<-dredge(lme.p.accndvi.lt, beta="sd") #intercept only is best model. Disappointing.
print(head(dredge.p.accndvi.lt))
...
dredge.phi.accndvi.lt<-dredge(lme.phi.accndvi.lt, beta="sd") #model with TSI is unconvincingly better than intercept-only (dAIC = 0.92)
print(head(dredge.phi.accndvi.lt))
