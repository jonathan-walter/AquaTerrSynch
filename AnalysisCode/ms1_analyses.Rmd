...
fm.p.accndvi.st<-gls(accndvip.ts1 ~ tslength + maxdepth + nhd_ftype + lake_area_ha + pct.ag + chla + tsi.cat + huc2_code, data=modvars.accndvi,
                       correlation=corExp(form = ~ nhd_lat + nhd_long))
summary(fm.p.accndvi.st)
...
fm.phi.accndvi.st<-gls(cos(accndviphi.ts1) ~ maxdepth + nhd_ftype + lake_area_ha + pct.ag + chla + tsi.cat + huc2_code, data=modvars.accndvi,
                       correlation=corExp(form = ~ nhd_lat + nhd_long))
summary(fm.phi.accndvi.st)
dredge.phi.accndvi.st<-dredge(fm.phi.accndvi.st, beta="sd") #intercept only is best model. Disappointing.
...
fm.p.accndvi.lt<-gls(accndvip.ts2 ~ tslength + maxdepth + nhd_ftype + lake_area_ha + pct.ag + chla + tsi.cat + huc2_code, data=modvars.accndvi,
                       correlation=corExp(form = ~ nhd_lat + nhd_long))
summary(fm.p.accndvi.lt)
...
fm.phi.accndvi.lt<-gls(cos(accndviphi.ts2) ~ maxdepth + nhd_ftype + lake_area_ha + pct.ag + chla + tsi.cat + huc2_code, data=modvars.accndvi,
                       correlation=corExp(form = ~ nhd_lat + nhd_long))
summary(fm.phi.accndvi.lt)
dredge.phi.accndvi.lt<-dredge(fm.phi.accndvi.lt, beta="sd") #intercept only is best model. Disappointing.
